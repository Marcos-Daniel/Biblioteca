...
public class GerenciarFuncionarios extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        int posicao = tblUsuarios.getSelectedRow();
        Funcionario funcionario = busca.get(posicao);
        this.preencheCampos(funcionario);
    ...
    public void filtrar(String nome,String cpf){
        ...
        Funcionario filtro = new Funcionario(0,nome,null,cpf,null,null);
   
        this.busca = (ArrayList<Funcionario>) dao.filtrar(filtro);
     
        preencheTabela(busca);
    }   
    
    public void buscarTodos(){
        this.busca = (ArrayList<Funcionario>) dao.buscar();
        
        preencheTabela(busca);
    }

    public void preencheTabela(ArrayList<Funcionario> busca) {
    ...
    private void preencheCampos(Funcionario funcionario){
        ...
        txtNResidencia.setText(funcionario.getNumeroResidencia());
    } 
}
